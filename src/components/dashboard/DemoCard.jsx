...
const DemoCard = () => {
  ...
  return (
    <div className={`w-[100%] lg:w-[60%] md:w-[60%] mx-auto mt-10 rounded-4xl p-8 flex justify-between flex-col lg:flex-row md:flex-row bg-[#080514]/40 border border-white/20`}>
      ...
      <div className="w-[100%] lg:w-[60%] md:w-[60%] my-3">
        ...
        <div className="">
          <button className="bg-linear-to-r p-3 from-orange to-lightOrange rounded-xl text-white text-[12px]">
            Play Video
          </button>
          <button
