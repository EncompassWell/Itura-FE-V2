...
const FAQ = () => {
  ...
  return (
    <div className="lg:w-[80%] md:w-[80%] w-[90%] mx-auto lg:my-30 md:my-24 my-14 overflow-hidden">
      <h2 className="text-[42px] lg:text-[56px] md:text-[56px] font-medium text-center mb-10">
        Your Questions,{" "}
